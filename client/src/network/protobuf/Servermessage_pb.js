 ...
 * @const
 */
proto.ServerMessage.oneofGroups_ = [[2,6,100,101]];
...
/**
 * optional EntityDestroyed entityDestroyed = 6;
 * @return {?proto.ServerMessage.EntityDestroyed}
 */
proto.ServerMessage.prototype.getEntitydestroyed = function() {
  return /** @type{?proto.ServerMessage.EntityDestroyed} */ (
    jspb.Message.getWrapperField(this, proto.ServerMessage.EntityDestroyed, 6));
};
